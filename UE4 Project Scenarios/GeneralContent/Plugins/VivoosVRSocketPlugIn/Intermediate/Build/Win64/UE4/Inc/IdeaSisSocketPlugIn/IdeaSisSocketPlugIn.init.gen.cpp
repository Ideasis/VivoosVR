...
void EmptyLinkFunctionForGeneratedCodeIdeaSisSocketPlugIn_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_IdeaSisSocketPlugIn()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/IdeaSisSocketPlugIn")), false, false));
